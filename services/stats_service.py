...
from queries import count_recent_predictions, get_detection_objects_for_recent_predictions
...
def get_stats_service(username: str, db: Session):
    ...
    detections = get_detection_objects_for_recent_predictions(db, username, one_week_ago)
